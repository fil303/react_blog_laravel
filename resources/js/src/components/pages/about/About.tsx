                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            ...
                            <img src="images/author.jpg" alt="author" className="img-fluid w-100 mb-4" />
                            <h3 className="font-weight-light">Hello, I'm <span className="font-weight-bold">John Doe</span></h3>
